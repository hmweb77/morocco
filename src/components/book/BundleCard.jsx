...
import { 
   Download, ShoppingCart, CheckCircle, Zap, Shield, Award, Globe, ArrowRight, CreditCard, ExternalLink
} from 'lucide-react';

// Bundle Card Component with Stripe Integration
const BundleCard = ({ ebooks, onBuyBundle }) => {
  const totalOriginalPrice = ebooks.reduce((sum, ebook) => sum + ebook.originalPrice, 0);
  const bundlePrice = 29.00; // Fixed bundle price
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-right">
            <div className="text-3xl font-bold">Save €{savings.toFixed(2)}</div>
        ...
        >
          <div className="flex items-center justify-center gap-3">
            ...
            <span>Buy Bundle with Stripe</span>
